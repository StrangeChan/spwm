...
{  
   ...
   //设置该引脚为复用输出功能,输出TIM2 CH2的PWM脉冲波形	GPIOB.11
...
void TIM1_Init(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_12;//|GPIO_Pin_0|GPIO_Pin_8|GPIO_Pin_9;
...
{		 		
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_8|GPIO_Pin_11; //TIM_CH2 //TIM_CH4
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;  //复用推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(GPIOA, &GPIO_InitStructure);
